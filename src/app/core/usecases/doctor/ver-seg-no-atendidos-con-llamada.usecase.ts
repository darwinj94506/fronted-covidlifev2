...
export class VerSeguimientosNoAtendidosConLLamadaUseCase implements UseCase<void, ISeguimientoEntity> {
  
  constructor(private _segRepositorio: SeguimientoRepositorio) { }
  
  execute(): Observable<ISeguimientoEntity> {
    return this._segRepositorio.getSeguimientosPorEstado(SeguimientoEstadoEnum.SOLICITADO_CON_LLAMADA)
  }
